# DJ Schedule - April 2026

## CRU Champagne Bar & Cocoa XO
Centara Grand at Central World, Bangkok

**Performance Hours:** 21:00 - 01:00 (4 hours per venue)
...
| Apr 5 | Sun | Izaar | JJ |
| Apr 6 | Mon | UFO | Tohmo |
| Apr 7 | Tue | Manymaur | Krit |
| Apr 8 | Wed | Linze | Benji |
...
## Payment Summary (Estimated)

**Rate:** ฿3,040 net per shift (4 hours)
...
| | Shifts | Gross (฿) | WHT (฿) | Net to DJs (฿) |
|-|--------|-----------|---------|----------------|
| Both Venues | 60 | 192,000 | 9,600 | 182,400 |

---

## Notes

- Camilo moves from CRU Saturday to CRU Friday (replaces Eskay Da Real)
- April returns to CRU Saturday
- Eskay Da Real not available in April
- Pound plays CRU Thursday + Cocoa XO Saturday
- Linze plays CRU Wednesday + Cocoa XO Friday
- Tohmo plays Cocoa XO Monday + Thursday (9 shifts total)
- Songkran (Apr 11-15) may require schedule adjustments if special program is confirmed

---

## Contact for Changes

Schedule changes require minimum 2 hours notice before performance.
Weather cancellations possible (outdoor venues).
